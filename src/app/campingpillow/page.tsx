...
export const metadata = {
  ...
  description: 'Experience a restful night sleep on your camping trips with our selection of top-rated camping pillows.',
  keywords: ' camping pillow, outdoor pillow, portable pillow, inflatable pillow, compact pillow, camping gear, camping essentials, neck support pillow, travel pillow, lightweight pillow, camping accessories, camping bedding, camping comfort, camping pillow reviews, camping pillow for sleeping,'
}

const getCampingPillowPosts = async () => {
  const res = await client.fetch(`*[_type=='posts' && category=='CAMPING PILLOW'] | order(date desc)`);
