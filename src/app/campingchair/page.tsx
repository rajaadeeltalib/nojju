...
export const metadata = {
  title: 'Camping Chair',
  description: 'Stay comfortable on your camping trips with our selection of top-rated camping chairs, designed for relaxation.',
  keywords: 'camping chair, outdoor chair, portable chair, folding chair, lightweight chair, camping furniture, camping seating, camping gear, camping essentials, reclining chair, camping lounge chair, camping chair with side table, camping chair with cup holder, camping chair reviews, camping chair comfort,'
}

const getCampingchairPosts = async () => {
  const res = await client.fetch(`*[_type=='posts' && category=='CAMPING CHAIR'] | order(date desc)`);
