...
export const metadata = {
  ...
  description: 'Stay refreshed on your camping trips with our selection of top-rated camping coolers, designed to keep your supplies cold.',
  keywords: 'camping cooler, outdoor cooler, portable cooler, camping ice chest, insulated cooler, camping gear, camping essentials, cooler box, camping food storage, camping accessories, camping ice cooler, camping beverage cooler, camping cooler reviews,'
}

const getCampingCoolerPosts = async () => {
  const res = await client.fetch(`*[_type=='posts' && category=='CAMPING COOLER'] | order(date desc)`);
