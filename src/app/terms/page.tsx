  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="text-justify my-8 mx-6 leading-8">
        <p >Welcome to Nojju!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Nojju&#39;s Website, located at https://www.nojju.com/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Nojju if you do not agree to take
        ...
        <p>
          We employ the use of cookies. By accessing Nojju, you agreed to use
          cookies in agreement with the Nojju&#39;s Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Nojju and/or its licensors own the
          intellectual property rights for all material on Nojju. All
          intellectual property rights are reserved. You may access this from
          Nojju for your own personal use subjected to restrictions set in these
          terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Nojju</li>
          <li>Sell, rent or sub-license material from Nojju</li>
          <li>Reproduce, duplicate or copy material from Nojju</li>
          <li>Redistribute content from Nojju</li>
        </ul>
        ...
        <p>
          ...
          Nojju does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of Nojju,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Nojju shall not be liable for
        ...
        <p>
          Nojju reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Nojju a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of Nojju; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to Nojju. Please include your name, your
        ...
        <p>
          No use of Nojju&#39;s logo or other artwork will be allowed for
