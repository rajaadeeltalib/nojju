      ...
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div className="md:max-w-md lg:col-span-2">
            ...
            <div className="mt-4 lg:max-w-sm">
              ...
              Discover the best camping gear for your outdoor adventures. From camping tents and sleeping bags to portable stoves and lanterns, our blog provides expert reviews, recommendations, and product guides.
              </p>
              <p className="mt-4 text-sm text-gray-800">
              Elevate your camping experience with high-quality equipment. Start exploring now!
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t sm:flex-row">
          <p className="text-sm text-gray-600">
            © Copyright 2023 Nojju. All rights reserved.
          </p>
